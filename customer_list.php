  ...
  <!-- display category list  -->
   ...
   <div class="container my-5">
        ...
        <h2 class="">Customer List</h2>
            <div>
            <a href="add_customer.php" class="btn btn-success d-block my-2" role="button">
        Add Supplier
        </a>
            </div>
        </div>
            ...
            <?php
                    ...
                    if($supplier_list->num_rows > 0){
                        ...
                        if($status == 1) {
                          ...
                          $active_supplier = "<span class='badge bg-warning text-dark'>Inactive</span>";
                              ...
                              <td>
                                  ...
                                  <a href='#?id=$id' class='btn btn-danger btn-sm text-white' data-bs-toggle='tooltip' 
                                  title='Delete'>
                      ...
                      <p class='text-center text-muted bg-light py-3 rounded border'>
                        <i class='bi bi-info-circle me-2'></i> No customer available at the moment.
                      </p>
                          ";
                    }
