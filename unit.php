      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="form-horizontal" method="POST" id="submitBrandForm" action="./php_action/create_unit.php" enctype="multipart/form-data">
              <!-- Unit Name -->
  ...
  <!-- display category list  -->
   ...
   <div class="container my-5">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <?php
                    $active_unit='';
                    $unit_list = $db->query("SELECT * FROM unit");
                    if($unit_list->num_rows > 0){
                      $counter = 1;
                      while (list($id,$unit,$status) = $unit_list->fetch_row()) {
                        if($status == 1) {
                          // activate member
                          $active_unit = "<span class='badge bg-success'>Active</span>";
                        } else {
                          // deactivate member
                          $active_unit = "<span class='badge bg-warning text-dark'>Inactive</span>";
                        }
                              ...
                              <td>$active_unit</td>
                              <td>
                                  <a href='./edit_form_unit.php?id=$id'' 
