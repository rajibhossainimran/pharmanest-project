...
<div class="container mt-2 mb-5">
    ...
    <form method="POST" id="purchaseBtnSubmit" action="./php_action/invoice_return.php?update=<?php echo $id;?>" enctype="multipart/form-data">
    ...
    if ($purchase_list->num_rows > 0) {
        while (list($id, $medicine_id, $quantity, $total_price, $qtnpurchase_invoice) = $purchase_list->fetch_row()) {
            ...
            echo "
                ...
                <td>
                    <input type='number' class='form-control' name='totalCost[]' value='{$total_price}'required>
                </td>
                 <td>
    ...
    ?>
        ...
        <div class="row ">
            ...
            <button type="submit" class="btn btn-danger" name="update">Sale Return</button>
